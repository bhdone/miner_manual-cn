...
btchd-miner deposit --check --valid
 ...
 200381 [   point  ] 0b2292e644a34b0793dd5ad1ef34ea2f7fc9fa3e19823b5d810bc8c8d46e7373 --> 2NGWAccrksGM4TmefLN4qyW1kV7VpMngtBQ
 12,345 BHD [  term1 ] actual:      2,469 BHD withdraw:         42 BHD

   --   [   point  ] e2e2aa173b5502b63d1c886468b5dd2d96c4018a21b7db7ea26f7169f635320e --> 2NGWAccrksGM4TmefLN4qyW1kV7VpMngtBQ
32,323 BHD [  term3 ] actual:      2,585 BHD withdraw:     32,323 BHD

\end{minted}
\normalsize
\begin{flushleft}
    以上是一台测试机上关于质押的查询结果，一共查询出两条质押记录，以下为各栏目的说明：
\end{flushleft}
\begin{itemize}
    ...
    \item actual - 根据锁定的类型，当前区块上实际的质押金额；
